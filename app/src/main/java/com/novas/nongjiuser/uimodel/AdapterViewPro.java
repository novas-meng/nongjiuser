...
public  class AdapterViewPro<T extends Adapter> extends ViewGroup {
    ...
    public AdapterViewPro(Context context) {
        this(context, null);
    }

    public AdapterViewPro(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public AdapterViewPro(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public interface OnItemClickListener {
         ...
         */
        void onItemClick(AdapterViewPro<?> parent, View view, int position, long id);
    }
    ...
    public interface OnItemLongClickListener {
         ...
         */
        boolean onItemLongClick(AdapterViewPro<?> parent, View view, int position, long id);
    }
    ...
    public interface OnItemSelectedListener {
         ...
         */
        void onItemSelected(AdapterViewPro<?> parent, View view, int position, long id);
         ...
         */
        void onNothingSelected(AdapterViewPro<?> parent);
    }
    ...
    class AdapterDataSetObserver extends DataSetObserver {
        ...
        public void onChanged() {
            ...
            if (AdapterViewPro.this.getAdapter().hasStableIds() && mInstanceState != null
                    && mOldItemCount == 0 && mItemCount > 0) {
                AdapterViewPro.this.onRestoreInstanceState(mInstanceState);
                mInstanceState = null;
            } else {
                rememberSyncState();
            }
        ...
        public void onInvalidated() {
            ...
            if (AdapterViewPro.this.getAdapter().hasStableIds()) {
                // Remember the current state for the case where our hosting activity is being
                // stopped and later restarted
                mInstanceState = AdapterViewPro.this.onSaveInstanceState();
            }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        ...
        info.setClassName(AdapterViewPro.class.getName());
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(AdapterViewPro.class.getName());
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        System.out.println(widthMode+"   "+heightMode);
    }
